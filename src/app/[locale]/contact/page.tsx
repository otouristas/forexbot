      ...
      <div className="mb-8">
        <div className="flex border-b">
          ...
          <button
            ...
            className={`px-4 py-2 ${activeTab === 'contact' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-600'}`}
          >
            Επικοινωνία
          </button>
        </div>
        ...
        <div className="mt-8">
          {activeTab === 'about' && (
            <div>
              ...
              <p className="mb-4">
                Χρησιμοποιούμε third-party πλατφόρμες όπως Darwinex και Myfxbook για να εξασφαλίσουμε ανεξάρτητη επαλήθευση.
                Δεν πωλούμε προϊόντα ή υπηρεσίες – όλα τα στοιχεία είναι διαθέσιμα δωρεάν για εκπαιδευτικούς σκοπούς.
              </p>
              <p>
                Η φιλοσοφία μας: Διαφάνεια, εκπαίδευση, και υπεύθυνο trading.
              </p>
            </div>
          )}
          ...
          {activeTab === 'contact' && (
            <div>
              ...
              <p className="mt-4 text-sm text-gray-600">
                Email: info@forexbot.gr | Τοποθεσία: Ελλάδα
              </p>
            </div>
          )}
        </div>
